...
with middle_panel:
    ...
    with st.container(border=True):
        ...
        if (
            st.session_state["ui_language"].lower().startswith("zh")
            and saved_voice_name
            and not saved_voice_name.lower().startswith("zh-")
        ):
            saved_voice_name = "zh-CN-XiaoxiaoNeural-Female"
            config.ui["voice_name"] = saved_voice_name
