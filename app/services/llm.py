...
def generate_terms(video_subject: str, video_script: str, amount: int = 5) -> List[str]:
    prompt = f"""
# Role: Stock Video Search Director

## Goals:
Generate {amount} precise search terms for stock video websites like Pexels and Pixabay.
The terms must help find concrete footage that visually supports the video script.

## Constrains:
1. the search terms are to be returned as a json-array of strings.
2. each search term should consist of 2-5 English words.
3. you must only return the json-array of strings. you must not return anything else. you must not return the script.
4. the search terms must describe visible scenes, actions, people, objects, places, or moods that can actually appear in stock footage.
5. reply with english search terms only.
6. avoid abstract words that stock sites cannot show directly, such as "success", "meaning", "future", "mindset", "value", "growth", "life", "money" unless paired with a concrete visual scene.
7. prefer cinematic B-roll phrases: "person studying desk", "hands typing laptop", "city office workers", "morning exercise park".
8. cover different visual angles from the script instead of repeating synonyms.
9. if the subject is Chinese, translate the visual meaning into natural English stock-video search phrases.
10. do not include brand names, platform names, copyrighted characters, or overly specific proper nouns.

## Output Example:
["person studying desk", "hands typing laptop", "quiet library reading", "focused office worker", "morning routine planning"]
